...
var provider = require( "./src/api/cloud/provider/index.ts");
var error = require( "./src/utils/error.ts");
var type = require( "./src/utils/type.ts");
var index = require( "./src/api/index.ts");
var Cloud =  (function () {
    function Cloud() {
        var _this = this;
        this.inited = false;
...
(function(module, exports, require) {
var tcb = require( "./src/api/cloud/provider/tcb/index.ts");
var PROVIDER;
(function (PROVIDER) {
...
var error_config = require( "./src/api/cloud/provider/tcb/config/error.config.ts");
...
var tcb = require( "tcb-admin-node");
var error_config = require( "./src/api/cloud/provider/tcb/config/error.config.ts");
var error_config_2 = require( "./src/config/error.config.ts");
var sleep = function (ms) {
    if (ms === void 0) { ms = 0; }
    return new Promise(function (resolve) { return setTimeout(resolve, ms); });
};
...
var tcb = require( "tcb-admin-node");
var tcbRequest = require( "tcb-admin-node/src/utils/httpRequest");
var database = require( "./src/api/cloud/provider/tcb/api/database.ts");
var callFunction = require( "./src/api/cloud/provider/tcb/api/callFunction.ts");
var downloadFile = require( "./src/api/cloud/provider/tcb/api/downloadFile.ts");
var uploadFile = require( "./src/api/cloud/provider/tcb/api/uploadFile.ts");
var deleteFile = require( "./src/api/cloud/provider/tcb/api/deleteFile.ts");
var getTempFileURL = require( "./src/api/cloud/provider/tcb/api/getTempFileURL.ts");
var callOpenAPI = require( "./src/api/cloud/provider/tcb/api/callOpenAPI.ts");
var provider = {
    // init
...
(function(module, exports, require) {
var database = require( "./src/api/database/api/database.ts");
function getAPIs(cloud) {
    return {
        database: database.default.bind(null, cloud),
    };
}
...
var tslib = require( "tslib");
var tcb = require( "tcb-admin-node");
var collection = require( "./src/api/database/api/database/collection.ts");
var assert = require( "./src/utils/assert.ts");
var msg = require( "./src/utils/msg.ts");
var error = require( "./src/utils/error.ts");
var error_checker = require( "./src/api/database/api/database/helper/error-checker.ts");
var _ = require( "./src/api/database/index.ts");
...
var getDatabaseClass = function (cloud) {
    return  (function () {
        function Database(config) {
            ...
            var overridenConfig = cloud.getOverriddenConfig(config || {}, _.DATABASE_SERVICE_NAME);
        ...
        Database.prototype.collection = function (collectionName) {
            return new collection.CollectionReference(this._db.collection(collectionName), collectionName, this);
        };
        Database.prototype.createCollection = function (collectionName) {
            return tslib.__awaiter(this, void 0, void 0, function () {
                var apiName, result, e;
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            e = _a.sent();
                            return [2 , error.returnAsFinalCloudSDKError(e, apiName)];
                        case 4: return [2 ];
                    }
                });
            });
...
(function(module, exports, require) {
var tslib = require( "tslib");
var query = require( "./src/api/database/api/database/query.ts");
var document = require( "./src/api/database/api/database/document.ts");
var msg = require( "./src/utils/msg.ts");
var error = require( "./src/utils/error.ts");
var assert = require( "./src/utils/assert.ts");
var error_checker = require( "./src/api/database/api/database/helper/error-checker.ts");
var CollectionReference =  (function (_super) {
    ...
    CollectionReference.prototype.doc = function (docId) {
        return new document.DocumentReference(this._collection.doc(docId), this, docId, this.database);
    };
        ...
        return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err = _a.sent();
                        reject(error.returnAsFinalCloudSDKError(err, apiName));
                        return [3 , 3];
                    case 3: return [2 ];
                }
            });
        ...
        return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err = _a.sent();
                        reject(error.returnAsFinalCloudSDKError(err, GET_API_NAME));
                        return [3 , 3];
                    case 3: return [2 ];
                }
            });
...
(function(module, exports, require) {
var callFunction = require( "./src/api/functions/api/callFunction.ts");
function getAPIs(cloud) {
    return {
        callFunction: callFunction.default(cloud),
    };
}
exports.getAPIs = getAPIs;
 }),
...
var assert = require( "./src/utils/assert.ts");
var error = require( "./src/utils/error.ts");
var _ = require( "./src/api/functions/index.ts");
var msg = require( "./src/utils/msg.ts");
function getCallFunction(cloud) {
    return function callFunction(options) {
        ...
        return new Promise(function (resolve, reject) { return tslib.__awaiter(_this, void 0, void 0, function () {
            var result, parsedResult, e, error;
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options) {
                    ...
                    case 1:
                        ...
                        return [4 , cloud.provider.api.callFunction({
                                name: options.name,
                                data: options.data || {},
                            }, cloud.getOverriddenConfig(options.config || {}, _.FUNCTIONS_SERVICE_NAME))];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        e = _a.sent();
                        error = error.returnAsFinalCloudSDKError(e, apiName);
                        // @ts-ignore
...
(function(module, exports, require) {
var api = require( "./src/api/functions/api/api.ts");
...
"./src/api/index.ts":
(function(module, exports, require) {
var database = require( "./src/api/database/index.ts");
var storage = require( "./src/api/storage/index.ts");
var functions = require( "./src/api/functions/index.ts");
var open = require( "./src/api/open/index.ts");
var utils = require( "./src/api/utils/index.ts");
function registerServices(cloud) {
    database.registerService(cloud);
    storage.registerService(cloud);
    functions.registerService(cloud);
    open.registerService(cloud);
    utils.registerService(cloud);
}
exports.registerServices = registerServices;
 }),
"./src/api/open/api/api.ts":
(function(module, exports, require) {
var callOpenAPI = require( "./src/api/open/api/callOpenAPI.ts");
function getAPIs(cloud) {
    return {
        callOpenAPI: callOpenAPI.default(cloud),
    };
}
exports.getAPIs = getAPIs;
 }),
...
(function(module, exports, require) {
var api = require( "./src/api/open/api/api.ts");
...
(function(module, exports, require) {
var uploadFile = require( "./src/api/storage/api/uploadFile.ts");
var downloadFile = require( "./src/api/storage/api/downloadFile.ts");
var getTempFileURL = require( "./src/api/storage/api/getTempFileURL.ts");
var deleteFile = require( "./src/api/storage/api/deleteFile.ts");
function getAPIs(cloud) {
    return {
        uploadFile: uploadFile.default(cloud),
        downloadFile: downloadFile.default(cloud),
        getTempFileURL: getTempFileURL.default(cloud),
        deleteFile: deleteFile.default(cloud),
    };
}
exports.getAPIs = getAPIs;
 }),
...
var assert = require( "./src/utils/assert.ts");
var error = require( "./src/utils/error.ts");
var _ = require( "./src/api/storage/index.ts");
var msg = require( "./src/utils/msg.ts");
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 , cloud.provider.api.deleteFile({
                                fileList: options.fileList
                            }, cloud.getOverriddenConfig(options.config || {}, _.STORAGE_SERVICE_NAME))];
                    case 2:
                        result = _a.sent();
                        return [2 , resolve({
...
(function(module, exports, require) {
var api = require( "./src/api/storage/api/api.ts");
...
(function(module, exports, require) {
var getWXContext = require( "./src/api/utils/api/getWXContext.ts");
function getAPIs() {
    return {
        getWXContext: getWXContext.default,
    };
}
exports.getAPIs = getAPIs;
 }),
...
function getWXContext() {
    ...
    try {
        ...
        var wxContext = {};
        try {
            for (var contextKeys = tslib.__values(contextKeys), contextKeys = contextKeys.next(); !contextKeys.done; contextKeys = contextKeys.next()) {
                var key = contextKeys.value;
                if (!key)
                    continue;
            ...
            try {
                if (contextKeys && !contextKeys.done && (_a = contextKeys.return)) _a.call(contextKeys);
            }
...
(function(module, exports, require) {
var api = require( "./src/api/utils/api/api.ts");
...
"./src/index.ts":
(function(module, exports, require) {
var cloud = require( "./src/api/cloud/index.ts");
module.exports = cloud.default.exportAPI;
 }),
"./src/utils/assert.ts":
(function(module, exports, require) {
var type = require( "./src/utils/type.ts");
var error = require( "./src/utils/error.ts");
var error_config = require( "./src/config/error.config.ts");
...
"./src/utils/type.ts":
(function(module, exports, require) {
var symbol = require( "./src/utils/symbol.ts");
